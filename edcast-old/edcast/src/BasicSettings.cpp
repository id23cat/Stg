...
void CBasicSettings::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Control(pDX, IDC_SAMPLERATE, m_SampleRateCtrl);
	DDX_Control(pDX, IDC_CHANNELS, m_ChanelsCtrl);
	DDX_Control(pDX, IDC_MOUNTPOINT, m_MountPointCtrl);
	DDX_Control(pDX, IDC_PASSWORD, m_PasswordCtrl);
	DDX_Control(pDX, IDC_RECONNECTSECS, m_ReconnectSecsCtrl);
	DDX_Control(pDX, IDC_SERVER_IP, m_ServerIpCtrl);
	DDX_Control(pDX, IDC_SERVER_PORT, m_ServerPortCtrl);
}
