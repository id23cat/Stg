...
DECLARE_COMPONENT_VERSION(
	...
	"3.x",
	"edcast\n"
	"Written by oddsock@oddsock.org\n"
	);
static int isShown = 0;
//static cfg_int edcast_show_on_startup("dsp_edcastv2",0);//in 0.1 dB
...
class dsp_edcast : public dsp_impl_base {
	bool m_chunk_valid;
...
class initquit_edcast : public initquit
{
public:
...
class edcast_play_callback_ui : public play_callback_static
{
...
static dsp_factory_nopreset_t<dsp_edcast> odd_foo;

//static dsp_factory_t<dsp_edcast> odd_foo;

//static service_factory_single_t<dsp_edcast> odd_foo;
static service_factory_single_t<initquit_edcast> odd_foo_init;
static service_factory_single_t<edcast_play_callback_ui> odd_foo_play_callback;